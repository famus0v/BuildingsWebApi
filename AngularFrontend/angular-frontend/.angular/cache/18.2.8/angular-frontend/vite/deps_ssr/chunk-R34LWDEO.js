...
DialogTitleBarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    ...
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_0 = goog.getMsg("Close");
      i18n_0 = MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_0;
    } else {
...
DialogComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_1;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_1 = goog.getMsg("Close");
      i18n_1 = MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_1;
    } else {
...
WindowComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_2;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_2 = goog.getMsg("Close");
      i18n_2 = MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_2;
    } else {
      i18n_2 = $localize`:kendo.window.closeTitle|The title of the close button:Close`;
    }
    let i18n_3;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_3 = goog.getMsg("Restore");
      i18n_3 = MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_3;
    } else {
      i18n_3 = $localize`:kendo.window.restoreTitle|The title of the restore button:Restore`;
    }
    let i18n_4;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_4 = goog.getMsg("Maximize");
      i18n_4 = MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_4;
    } else {
      i18n_4 = $localize`:kendo.window.maximizeTitle|The title of the maximize button:Maximize`;
    }
    let i18n_5;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_5 = goog.getMsg("Minimize");
      i18n_5 = MSG_F__PROJECT_BUILDINGSWEBAPI_ANGULARFRONTEND_ANGULAR_FRONTEND_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DIALOG_FESM2015_PROGRESS_KENDO_ANGULAR_DIALOG_MJS_5;
    } else {
...
//# sourceMappingURL=chunk-R34LWDEO.js.map
